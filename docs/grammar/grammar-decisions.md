# FoLang Grammar and Semantic Decision Register — Revision 21

- Grammar: `folang-r19.ebnf`
...
- Revision 21 restricts entry-file type declarations to their non-generic
  allowlist, admits contextual `.for` member access, makes contextual lambda
  and wildcard calls receiver-aware and grouping-transparent, and records the
  finalized operator ownership, operand-normalization, and mode rules.
